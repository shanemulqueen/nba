...
df1 = pd.read_csv('~\Documents\BasketballBetting/salary_data2019.csv', encoding="ISO-8859-1")
df2 = pd.read_csv('~\Documents\BasketballBetting/2019Data.csv', encoding="ISO-8859-1")
map_df = pd.read_csv('~\Documents\BasketballBetting/dk_player_map.csv', encoding="ISO-8859-1")
